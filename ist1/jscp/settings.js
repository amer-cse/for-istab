...
let settings = {
    ...
    pages: [
        ...
        },
        {
            ...
            content: "I am so sorry, Istabraq. My heart aches knowing I hurt you."
        },
        ...
        },
        {
            ...
            content: "You mean everything to me. Please give me a chance to make it right."
        }
    ],
    enableBook: true,
    enableHeart: true,
    ...
    try {
        ...
        if (result.success && result.data) {
            ...
            window.settings = {
                ...
                sequence: serverSettings.sequence || 'FORGIVE|ME|ISTABRAQ|❤',
...
applySettingsButton.addEventListener('click', () => {
    ...
    settings.sequence = document.getElementById('sequenceText').value || 'FORGIVE|ME|ISTABRAQ|❤';
