...
const translations = {
    vi: {
        title: "For Istabraq ❤️",
        description: "A heartfelt apology, just for you, Istabraq. Please read this with an open heart.",
        ...
        copyright: 'Website được tạo riêng cho Istabraq ❤️',
        ...
        endOfBook: "Hết sách",
        loading: "Opening my heart for you...",
        waitingIsHappiness: "Some things are worth the wait.",
        ...
        followNote: "❤️ Made with love, just for Istabraq.",
        on: "Bật",
        off: "Tắt",
        sec3: "3 giây",
        sec5: "5 giây",
        sec10: "10 giây",
        noGif: "Không có",
        notVietnamWarning: 'Nếu gặp vấn đề, hãy liên hệ trực tiếp.',
        ...
        colorTheme: "Chọn màu:",
        settingsHint: "click here to customize",
    ...
    en: {
        ...
        follow: "❤️ Made with love, just for Istabraq.",
        apply: "Apply Settings",
        copyright: 'Made with love, just for Istabraq ❤️',
        ...
        sec10: "10 seconds",
        noGif: "None",
        notVietnamWarning: 'If you encounter any issues, please reach out directly.',
...
function setLanguage(lang) {
    ...
    if (descMeta) descMeta.setAttribute('content', translations[lang].description);
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if(btn) btn.onclick = switchLanguage;
});
